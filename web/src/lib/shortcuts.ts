...
export type Action = 'down' | 'up' | 'open' | 'close' | 'help' | 'palette'
...
export const SHORTCUTS: readonly Shortcut[] = [
  { keys: 'j', action: 'down', description: 'next task' },
  { keys: 'k', action: 'up', description: 'previous task' },
  { keys: 'Enter', action: 'open', description: 'open the selected task' },
